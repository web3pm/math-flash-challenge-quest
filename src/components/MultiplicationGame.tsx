...
const MultiplicationGame: React.FC = () => {
  ...
  const handleAnswerSubmit = () => {
    ...
    setTimeout(() => {
      ...
      if (currentQuestionIndex + 1 >= questions.length) {
        ...
        toast({
          title: "Game Complete!",
          description: `Finished in ${totalTime.toFixed(1)}s with ${
  ...
  const progress =
    questions.length > 0
      ? (gameStats.correctAnswers / questions.length) * 100
      : 0;
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="p-4 text-center shadow-card">
            ...
            <div className="text-2xl font-bold text-primary">
              {currentQuestionIndex + (gameStarted ? 1 : 0)}/
              {questions.length || 144}
            </div>
          </Card>
        </div>
          ...
          {!gameStarted && !gameStats.isComplete ? (
            <div className="text-center space-y-6">
              ...
              <div className="bg-muted/50 rounded-lg p-6 space-y-3">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  ...
                  <li>
                    • Try to finish as fast as possible with fewest mistakes!
                  </li>
                </ul>
              </div>
            ...
            <div className="text-center space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  You completed all multiplication tables!
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <div
                  className={`text-6xl font-bold transition-all duration-300 ${
                    showResult
                      ? lastAnswerCorrect
                        ? "animate-pulse-correct text-success"
                        : "animate-pulse-incorrect text-error"
                      : ""
                  }`}
                >
                  {currentQuestion
                ...
                {showResult && (
                  <div
                    className={`text-2xl font-semibold animate-bounce-in ${
